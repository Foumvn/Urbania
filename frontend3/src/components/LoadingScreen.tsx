...
export default function LoadingScreen({ onFinished }: LoadingScreenProps) {
    ...
    return (
        ...
        >
            ...
            {/* Word List with Vertical Scroll - Masked Container */}
            <div
            ...
            >
                <motion.div
                    ...
                    animate={{ y: -currentIndex * 96 }} // 96px = gap + text height approx
                    transition={{
                        duration: 0.8,
                        ease: [0.4, 0, 0.2, 1]
                    }}
                ...
                >
                    {words.map((word, idx) => {
                        ...
                        // Calculate opacity: active = 1, one away = 0.45, two away = 0.25
                        let opacity = 0.15;
                        if (isActive) opacity = 1;
                        else if (distance === 1) opacity = 0.45;
                        else if (distance === 2) opacity = 0.25;

                        // Calculate scale: active = 1.05, others smaller
