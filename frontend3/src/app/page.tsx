...
export default function Home() {
  ...
  const benefits = [
    {
      ...
      description: "Créez votre dossier en moins d'une heure au lieu de several jours."
    },
    {
      icon: Shield,
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden text-foreground">
      {/* Header */}
      <motion.header
        className="fixed top-0 left-0 right-0 z-50 bg-background/60 backdrop-blur-xl border-b border-border/40 supports-[backdrop-filter]:bg-background/60"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        ...
        <section className="py-20 md:py-28 bg-primary relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <Link href="/signup">
                <motion.div whileHover={{ scale: 1.03, y: -2 }} whileTap={{ scale: 0.98 }}>
                  <Button size="lg" variant="secondary" className="gap-2 px-10 py-6 rounded-xl text-base font-bold shadow-xl">
              ...
              <Link href="/contact">
                <motion.div whileHover={{ scale: 1.03, y: -2 }} whileTap={{ scale: 0.98 }}>
                  <Button size="lg" variant="outline" className="gap-2 px-10 py-6 rounded-xl text-base font-bold bg-transparent text-primary-foreground border-primary-foreground/30 hover:bg-primary-foreground/10 hover:border-primary-foreground">
                    Nous contacter
                  </Button>
                </motion.div>
              </Link>
      ...
      <footer className="bg-card py-12 border-t border-border/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2 space-y-6">
              ...
              <p className="text-muted-foreground max-w-md">
                La première plateforme intelligente pour créer votre dossier de déclaration préalable de travaux.
                Sûr, rapide et 100% conforme.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-foreground mb-4">Produit</h4>
              <ul className="space-y-3">
                <li><Link href="#fonctionnalites" className="text-muted-foreground hover:text-primary transition-colors">Fonctionnalités</Link></li>
                <li><Link href="#comment-ca-marche" className="text-muted-foreground hover:text-primary transition-colors">Comment ça marche</Link></li>
                <li><Link href="/rendez-vous" className="text-muted-foreground hover:text-primary transition-colors">Rendez-vous</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-foreground mb-4">Légal</h4>
              <ul className="space-y-3">
                <li><Link href="/terms" className="text-muted-foreground hover:text-primary transition-colors">Mentions légales</Link></li>
          ...
          <div className="pt-8 border-t border-border/50 text-center text-sm text-muted-foreground">
            © {new Date().getFullYear()} Urbania. Tous droits réservés.
          </div>
        </div>
      </footer>
    </div>
