...
const carouselSlides = [
    {
        title: "Simplifiez vos démarches d'urbanisme",
        description: "Créez votre dossier de déclaration préalable en quelques clics grâce à notre plateforme intelligente."
    },
    {
        title: "Accompagnement personnalisé",
        description: "Bénéficiez de conseils d'experts pour valider votre dossier conformément au PLU local."
    },
    {
        title: "Gagnez du temps sur vos projets",
...
function Login() {
    ...
    return (
        <div className="min-h-screen bg-white flex text-slate-900 font-sans antialiased">
                ...
                <div className="flex-grow flex items-center justify-center p-8 md:p-12">
                    <div className="w-full max-w-md space-y-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-1">
                                <div className="flex items-center justify-between">
                                    ...
                                    <a href="#" className="text-sm font-semibold text-[#0056b2] hover:underline">
                                        Mot de passe oublié ?
                                    </a>
                                </div>
                                <div className="relative">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full bg-gradient-to-r from-[#002288] to-[#0056b2] text-white font-bold py-4 px-4 rounded-lg hover:opacity-90 transition-all transform active:scale-[0.99] shadow-xl shadow-blue-900/20 text-base disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                        ...
                        <p className="text-center text-sm text-slate-500">
                            ...
                            <Link to="/auth/register" className="font-bold text-[#0056b2] hover:underline">
                                Créer un compte
                            </Link>
                        </p>
                    </div>
            ...
            <section className="hidden lg:flex flex-col w-1/2 bg-[#002288] text-white relative items-center justify-center p-12 overflow-hidden">
